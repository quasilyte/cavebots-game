...
func registerAudioResources(ctx *ge.Context) {
	audioResources := map[resource.AudioID]resource.AudioInfo{
		...
		AudioGunnerShot1: {Path: "audio/gunner_shot1.wav"},
		AudioGunnerShot2: {Path: "audio/gunner_shot2.wav"},
		...
		AudioError:             {Path: "audio/error.wav", Volume: -0.35},
	}
